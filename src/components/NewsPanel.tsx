...
const FALLBACK_NEWS: NewsItem = {
  ...
  body:
    "One featured story, one strong image, a sharp headline and a direct read-more CTA. This block now behaves like a proper editorial feature instead of plain text dropped into the page.",
  image: "",
  ctaLabel: "READ MORE",
      ...
      <article className="news-feature-card">
        <div className="news-feature-media">
          <img
            ...
            loading="lazy"
            onError={(e) => {
              e.currentTarget.src = getRandomRockImage(featured.title);
            }}
          />
          <div className="news-feature-media-overlay" />
        </div>

        <div className="news-feature-copy">
          <span>METAL NEWS / FEATURED STORY</span>
