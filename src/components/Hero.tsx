export function Hero() {
  return (
    <section className="hero-panel metal-panel battered-panel js-reveal" id="home">
      <div className="hero-chains hero-chains-left" aria-hidden="true" />
      <div className="hero-chains hero-chains-right" aria-hidden="true" />
      <div className="hero-chain-top hero-chain-top-left" aria-hidden="true" />
      <div className="hero-chain-top hero-chain-top-right" aria-hidden="true" />

      <div className="hero-top">
        <div className="hero-emblem-wrap">
          <div className="hero-emblem-outer">
            <div className="hero-emblem">
              <span className="emblem-finger" />
              <span className="emblem-finger" />
              <span className="emblem-finger" />
              <span className="emblem-finger" />
        ...
        <div className="hero-logo-block">
          <div className="hero-logo-frame">
            <div className="hero-logo-inner">
              <div className="hero-logo-spikes" aria-hidden="true" />
        ...
        <div className="hero-badge metal-badge js-pulse">
